...
if [[ "${1:-}" == "--mac" ]]; then
    ...
    PLIST="$HOME/Library/LaunchAgents/com.brf.homeschool-sync.plist"
...
<dict>
    <key>Label</key>
    <string>com.brf.homeschool-sync</string>
    ...
    <dict>
        <key>REPO_DIR</key>
        <string>$HOME/homeschool</string>
        <key>BRANCH</key>
        <string>main</string>
        <key>LOGFILE</key>
        <string>$HOME/Library/Logs/homeschool-sync.log</string>
    </dict>
    ...
    <string>$HOME/Library/Logs/homeschool-sync.stdout.log</string>
    <key>StandardErrorPath</key>
    <string>$HOME/Library/Logs/homeschool-sync.stderr.log</string>
</dict>
</plist>
EOF
    ...
    echo "macOS profile installed. homeschool-sync will run every 15 minutes."
    echo "Logs: ~/Library/Logs/homeschool-sync.log"
fi
