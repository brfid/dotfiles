...
Use this repo with `~/src/agents` when setting up local LLM clients. Dotfiles owns tool paths and setup notes; agents owns reusable LLM agent config. An LLM adapts both into local config for the current machine.
