---
name: caveman-mode
description: Use when the user asks for caveman mode, terse low-token replies, fewer words, less filler, or blunt brevity without losing technical accuracy. Stays active until the user says "normal mode" or "stop caveman".
---
